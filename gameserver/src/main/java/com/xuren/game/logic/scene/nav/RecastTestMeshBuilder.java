...
public class RecastTestMeshBuilder {
    ...
    public RecastTestMeshBuilder(String path) {
        this(new ObjImporter().load(RecastTestMeshBuilder.class.getClassLoader().getResourceAsStream(path)),
    ...
    public RecastTestMeshBuilder(InputGeomProvider m_geom, RecastConstants.PartitionType m_partitionType, float m_cellSize,
        ...
        RecastBuilder.RecastBuilderResult rcResult = rcBuilder.build(m_geom, bcfg);
